...
function CoffeeMap() {
  ...
  const [region, setRegion] = useState<CountryList>({
    ...
    AGO: {
      nation: '앙고라',
      desc: '앙고라에서 생산되는 원두는 다른 지역에서 생산되는 원두와는 다른 독특한 특징을 가지고 있습니다. 첫번째로는 과일향이 강합니다. 보통 블랙베리, 로즈베리, 자두 등의 과일향을 느낄 수 있습니다. 두번 째 산미가 강합니다. 커피 산지가 높은 고지대이기 때문입니다. 그래서 단맛이 적고 산미와 향이 강합니다. 또한 바디감이 가볍습니다.',
      flags: angola,
    },
    MDG: {
      nation: '마다가스카르',
      desc: '마다가스카르에서 생산되는 원두는 체리, 레몬, 라즈베리, 자몽 등의 과일향이 나고, 높은 고도에서 재배되기 때문에 산미가 강한 편입니다. 앙고라와는 달리 단맛도 강한데, 이는 커피 산지에서 생산되는 과일향과 결합되어 달콤한 맛을 느낄 수 있습니다. 또한 끝맛이 부드러운 편인데, 산미와 과일향, 단맛을 느낀 후 부드럽게 마무리되는 맛을 느낄 수 있습니다.',
      flags: madagascar,
    },
    CIV: {
      nation: '코트디부아르',
      desc: '코트디부아르 원두는 과일향이 적은 특징을 가지고 있습니다. 대신 너트향, 초콜릿향이 느껴집니다. 산미는 적당한 편입니다. 너트향 초콜릿향이 나기때문에 단맛이 강한편인데 초콜릿, 카라멜, 꿀 등의 단맛이 느껴집니다. 이에 따라 바디감도 진한 편이고, 쌉쌀한 끝맛이 느껴집니다.',
      flags: ivorycoast,
    },
    LKA: {
      nation: '캄보디아',
      desc: '캄보디아 원두는 과일향이 강한편입니다. 보통 체리, 자두, 복숭아 등의 과일향을 느낄 수 있습니다. 또한 산미가 부드럽습니다. 다른 아시아 원산지에 비해 부드럽고 균형잡혀있습니다.  꿀, 갈색설탕 등의 단맛을 느낄 수 있고, 바디감은 가벼우면서 깔끔합니다. 마지막으로 고유한 풍미를 가지고 있는데 지역적 특성과 특정한 가공 방법에 의해 형성되는 것으로 알려져 있습니다.',
      flags: cambodia,
    },
