...
const Inner = tw.div`h-screen flex flex-row justify-end items-end bg-mainBg1 bg-cover`;
const ItemDiv = tw.div`flex flex-col justify-center items-center mb-1/10 mx-1/10`;
const TextDiv = tw.div`text-black text-6xl font-bold m-4 right-1/2 -bottom-3/4 text-right`;
