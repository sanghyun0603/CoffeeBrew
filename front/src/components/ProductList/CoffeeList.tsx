...
const ProductList = tw.div`flex justify-between mx-20 drop-shadow-2xl mb-4 `;
const ProductItemT = tw.div`w-72 h-400 justify-center rounded-t-2xl mb-8`;
const ProductItemT1 = tw(
  ProductItemT,
)`bg-brownBorder rounded-b-2xl drop-shadow-2xl`;
const ProductItemImg = tw.img`w-32 h-48  mx-auto mt-4 `;

const ProductItemB = tw.div`w-72 h-44  justify-center  bg-navColor mt-10 rounded-b-2xl rounded-t-2xl  drop-shadow-xl `;
