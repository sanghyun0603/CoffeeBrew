...
const ChoiceCard = tw.button`w-1/5 border border-mainOrige bg-mainOrige text-white flex flex-col items-center justify-center  py-10 px-5 mx-5 rounded-lg break-normal min-h-1/5`;
