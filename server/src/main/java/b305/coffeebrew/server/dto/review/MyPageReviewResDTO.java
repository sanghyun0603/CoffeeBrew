...
public class MyPageReviewResDTO {
	...
	@Builder
	public MyPageReviewResDTO(Long member_idx, String itemName,String itemType, String content, int overall, int flavor, int acidity, int sweetness, int bitterness, int body, String coffeeing_note, int like, boolean expired) {
